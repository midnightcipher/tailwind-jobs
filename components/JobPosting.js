...
export default function JobPosting({ children, metadata }) {
  return (
    <Layout>
      ...
      <article className="grid py-12 lg:grid-cols-3 lg:gap-16">
                ...
                <div className="py-4">
                  ...
                  <dl className="flex items-start space-x-2 text-sm leading-5">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500">North/South America</div>
                    </div>
                  </dl>
                </div>
                <div className="py-4">
                  ...
                  <dl className="flex items-start space-x-2 text-sm leading-5">
                    ...
                    <div style={{ 'font-variant-numeric': 'tabular-nums' }}>
                      <div className="text-gray-800">$105,000 – $120,000 USD</div>
                      <div className="text-gray-500">$145,000 – $165,000 CAD</div>
                    </div>
                  </dl>
                </div>
                <div className="py-4">
