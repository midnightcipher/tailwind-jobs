...
The salary for this position is <React.Fragment children="$"/>120,000 USD (or <React.Fragment children="$"/>165,000 CAD), paid in your local currency. We'll do the currency conversion when you're hired and deal with any exchange fluctuation on our side.
